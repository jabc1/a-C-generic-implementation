...
void stackNew(stack *s, int elemSize, void (*free_fn)(void *))
{
    ((elemSize > 0) ? (void) (0) : __assert_fail ("elemSize > 0", "stack.c", 49, __PRETTY_FUNCTION__));
    s->top = 0;
    s->size = 4;
    s->elemSize = elemSize;
    s->free_fn = free_fn;
    s->base = malloc(elemSize * 4);
    ((s->base != ((void *)0)) ? (void) (0) : __assert_fail ("s->base != ((void *)0)", "stack.c", 55, __PRETTY_FUNCTION__));
}
...
void stackGrow(stack *s)
{
    ...
    ((s->base != ((void *)0)) ? (void) (0) : __assert_fail ("s->base != ((void *)0)", "stack.c", 78, __PRETTY_FUNCTION__));
}
...
void stackPop(stack *s, void *value)
{
    ((s->top != 0) ? (void) (0) : __assert_fail ("s->top != 0", "stack.c", 92, __PRETTY_FUNCTION__));
    s->top --;
    void *elemAddr = (char *)s->base + s->top * s->elemSize;
